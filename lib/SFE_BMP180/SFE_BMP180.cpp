...
// Initialize library for subsequent pressure measurements
{
	...
	// I use FastWire and i will start manually
	//Wire.begin();
...
{
	return Fastwire::readBuf(BMP180_ADDR,values[0],values,length);
}
...
{
	return Fastwire::writeBuf( BMP180_ADDR, values[0], values+1, length-1);
}
